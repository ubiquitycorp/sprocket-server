...
//		Profile jack = new Profile.Builder().user(user).location(new UserLocation.Builder().location(
//				new Location.Builder().latitude(new BigDecimal(34.0522300)).longitude(new BigDecimal(-118.2436800)).build()).user(user).build()).build();
//		jack.getIdentities().add(contactBuilder.build());
//		profiles.add(jack);
//
...
//		
//		// build the profile with location
//		Profile john = new Profile.Builder().user(user).location(new UserLocation.Builder().location(
//				new Location.Builder().latitude(new BigDecimal(34.1234567)).longitude(new BigDecimal(-118.2412345)).build()).user(user).build()).build();
...
//		
//		// build the profile with location
//		Profile joe = new Profile.Builder().user(user).location(new UserLocation.Builder().location(
//				new Location.Builder().latitude(new BigDecimal(34.1334567)).longitude(new BigDecimal(-118.2499999)).build()).user(user).build()).build();
...
//		persistUser(user);
//		
//		Profile jill = new Profile.Builder().user(user).location(new UserLocation.Builder().location(
//				new Location.Builder().latitude(new BigDecimal(-34.6131500)).longitude(new BigDecimal(-58.3772300)).build()).user(user).build()).build();
...
//		persistUser(user);
//		
//		Profile jane = new Profile.Builder().user(user).location(new UserLocation.Builder().location(
//				new Location.Builder().latitude(new BigDecimal(-34.6231500)).longitude(new BigDecimal(-58.3872300)).build()).user(user).build()).build();
