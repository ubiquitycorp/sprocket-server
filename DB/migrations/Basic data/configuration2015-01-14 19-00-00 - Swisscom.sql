...
insert into `configuration` (`configuration_id`,`configuration_type`,`is_active`,`last_updated`,`name`,`value`,`external_network`) values  (1,0,1,1415285840335,'message.service.host','54.215.203.15',-1);
