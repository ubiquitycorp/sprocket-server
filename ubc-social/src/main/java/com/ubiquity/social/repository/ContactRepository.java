...
public interface ContactRepository extends Repository <Long, Contact> {
	 ...
	 * @return
	 */
	List<Contact> findByOwnerIdAndSocialIdentityProvider(Long ownerId, SocialNetwork type);
	 ...
	 * @return
	 */
	int countAllContactsByOwnerIdAndSocialIdentityProvider(Long ownerId, SocialNetwork socialProviderType);
}
